...
bathroom_count <- read_csv(
  "data/raw_data/2022-05-03_2022_spring_urban_ecology_data_Bathroom_count.csv")
...
ggmap(sf_basemap) +
  geom_point(data = bathroom_sample,
             aes(x = long_dec_degrees,
                 y = lat_dec_degrees,
                 color = neighborhood | bathroom_type),
             size = 6) +
  labs(title = "Bathroom Site sampled locations in San Francisco")
